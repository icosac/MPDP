 ...
 * the coordinates, the angle and the curvature of a point.
 */
...
class Configuration2 {
 ...
 public:
	 ...
	 */
	Configuration2 (real_type x, real_type y, Angle th, K_T k = 0)
			: _x (x), _y (y), _th (th), _k (k)
	{}
	 ...
	 */
	Configuration2&
	copy (const Configuration2& conf)
	{
		this->x (conf.x());
		this->y (conf.y());
		this->th (conf.th());
	 ...
	 */
	Configuration2&
	operator= (const Configuration2& conf)
	{
		this->copy (conf);
		return *this;
	}
