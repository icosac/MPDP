 ...
 */
bool
Dubins::comp_LRL(const struct Man_input_data& man_in_data, struct Man_output_data& man_out_data) const {
//  std::cout << "Computing LRL" << std::endl;
  ...
  real_type temp2 = 0.125*(6 - 4*man_in_data.Ksq + 2*man_in_data.dcos - 4*man_in_data.sKmax*man_in_data.dsin);
  if (std::abs(temp2) <= 1) {
    real_type t2 = man_in_data.invK * mod2pi(2*m_pi - std::acos(temp2));
    real_type t1 = man_in_data.invK * mod2pi(-man_in_data.th0 + temp1 + 0.5*t2*man_in_data.sKmax);
    real_type t3 = man_in_data.invK * mod2pi(-man_in_data.dth + (t2-t1)*man_in_data.sKmax);
    real_type lc = t1+t2+t3;
//    std::cout << std::setprecision(12) << "LRL len: " << lc << std::endl;
    if (lc < man_out_data.len) {
      man_out_data.len = lc; man_out_data.ss1 = t1; man_out_data.ss2 = t2; man_out_data.ss3 = t3;
      man_out_data.sk1 = 1; man_out_data.sk2 = -1; man_out_data.sk3 = 1;
 ...
 */
bool
Dubins::comp_RLR(const struct Man_input_data& man_in_data, struct Man_output_data& man_out_data) const {
 ...
 */
bool
Dubins::comp_LSL(const struct Man_input_data& man_in_data, struct Man_output_data& man_out_data) const {
//  std::cout << "Computing LSL" << std::endl;
  real_type C = man_in_data.cos_1 - man_in_data.cos_0;
  real_type S = 2 * man_in_data.sKmax + man_in_data.dsin;
  real_type temp1 = std::atan2(C, S);
  real_type temp2 = 2 + 4 * man_in_data.Ksq - 2 * man_in_data.dcos + 4 * man_in_data.sKmax * man_in_data.dsin;
...
//    std::cout << std::setprecision(12) << "LSL len: " << lc << std::endl;
    if (lc < man_out_data.len) {
      man_out_data.len = lc; man_out_data.ss1 = t1; man_out_data.ss2 = t2; man_out_data.ss3 = t3;
      man_out_data.sk1 = 1; man_out_data.sk2 = 0; man_out_data.sk3 = 1;
 ...
 */
bool
Dubins::comp_LSR(const struct Man_input_data& man_in_data, struct Man_output_data& man_out_data) const {
//  std::cout << "Computing LSR" << std::endl;
  real_type C = man_in_data.scos;
  real_type S = 2 * man_in_data.sKmax + man_in_data.ssin;
  real_type temp1 = std::atan2(-C, S);
  real_type temp2 = -2 + 4 * man_in_data.Ksq + 2 * man_in_data.dcos + 4 * man_in_data.sKmax * man_in_data.ssin;
  if (temp2 >= 0) {
 ...
 */
bool
Dubins::comp_RSL(const struct Man_input_data& man_in_data, struct Man_output_data& man_out_data) const {
 ...
 */
bool
Dubins::comp_RSR (const struct Man_input_data& man_in_data, struct Man_output_data& man_out_data) const {
