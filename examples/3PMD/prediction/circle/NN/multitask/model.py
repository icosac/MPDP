...
class NeuralNet(nn.Module):
    ...
    def __init__(self, in_size=5, hid_size=64, class_out_size=19, reg_out_size=2):  # Changed out_size to 2 for sin and cos
        ...
        self.class_head = nn.Linear(hid_size // 2, class_out_size)
        self.reg_head = nn.Linear(hid_size // 2, reg_out_size)
