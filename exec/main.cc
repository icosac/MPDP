...
//vector<Configuration2> createPoints(){
//  vector<Configuration2> ret;
//  for (int i=0; i<SIZE; i++){
//    ret.push_back(Configuration2(X[i], Y[i], ANGLE::INVALID));
//  }
//  return ret;
//}
...
vector<Configuration2> createPoints(){
  ...
  for (int i=0; i<SIZE*2; i+=2){
    ret.push_back(Configuration2(XY[i], XY[i+1], ANGLE::INVALID));
  }
  return ret;
}
...
vector<vector<Configuration2> > Tests = {
...
int main (){
  ...
  for (uint discr : discrs){
    ...
    for (uint j=0; j<Tests.size(); j++){
      ...
      vector<Configuration2> v=Tests[j];
      ...
      tp.start();
      cout << "\t";
      DP::solveDP(v, discr, fixedAngles, curveParam, false);
...
#define KAYA kaya1
  ...
  DP::solveDP(KAYA, DISCR, fixedAngles, curveParam, false);
